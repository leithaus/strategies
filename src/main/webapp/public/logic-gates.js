...
YUI_config.groups.wireit.base = 'wireit/build/';
...
YUI({
	...
	var containers_definitions = [
			...
			},
			{
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Abed_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Annie_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Britta_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Chang_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_DeanPelton_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_JeffWinger_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Pierce_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Shirley_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
				...
				config : {
					type: "AgentContainer", 
					imageUrl: "images/Rnd_Troy_Small.png",
  					children: [
  						{ offset: [58, 19], dir: [0.3, 0], name: '_OUTPUT', type: 'TerminalOutput' }
  					]
				}
	...
	Y.ClockContainer = Y.Base.create("clock-container", Y.LogicContainer, [], {
        ...
        Y.AgentContainer = Y.Base.create("agent-container", Y.LogicContainer, [], {
		initializer: function() {
			this.after('logicOutputChange', this._updateAgentImage, this);
			setInterval(Y.bind(this.switchLogicOutput, this), 1000);
		},
		_updateAgentImage: function(e) {
                        var currImgUrl = this.get( 'imageUrl' );
                        var splitUrl = currImgUrl.split( "/" );                       
                        var baseImgFileNameSfx = splitUrl[ splitUrl.length - 1 ];
                        var baseImgFileName = baseImgFileNameSfx.split( "." )[0];
                        var baseImgFileNameRoot =
                        ( ( baseImgFileName.split( "_" ).indexOf( "On" ) > -1 ) ? baseImgFileName.substring( 0, baseImgFileName.length - 3 ) : baseImgFileName );
			this.set('imageUrl', "images/"+baseImgFileNameRoot+(e.newVal ? "_On" : "")+".png");
		}
	});
