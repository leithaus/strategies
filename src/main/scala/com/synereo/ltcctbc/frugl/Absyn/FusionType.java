...
public class FusionType extends LTyp {
  public final LTyp ltyp_1, ltyp_2;

  public FusionType(LTyp p1, LTyp p2) { ltyp_1 = p1; ltyp_2 = p2; }

  public <R,A> R accept(com.synereo.ltcctbc.frugl.Absyn.LTyp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof com.synereo.ltcctbc.frugl.Absyn.FusionType) {
      com.synereo.ltcctbc.frugl.Absyn.FusionType x = (com.synereo.ltcctbc.frugl.Absyn.FusionType)o;
