...
public class Duplication extends Term {
  public final Term term_1, term_2;

  public Duplication(Term p1, Term p2) { term_1 = p1; term_2 = p2; }

  public <R,A> R accept(com.synereo.ltcctbc.frugl.Absyn.Term.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof com.synereo.ltcctbc.frugl.Absyn.Duplication) {
      com.synereo.ltcctbc.frugl.Absyn.Duplication x = (com.synereo.ltcctbc.frugl.Absyn.Duplication)o;
