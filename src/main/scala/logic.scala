...
trait GameOps[+PQ,+OA,+OQ,+PA] {
  ...
  type WBWOS[+PQ,+OA,+OQ,+PA] = WellBracketedWOST[PQ,OA,OQ,PA]
  type WBWPS[+PQ,+OA,+OQ,+PA] = WellBracketedWPST[PQ,OA,OQ,PA]
  ...
  def negate[PQ1 >: PQ,OA1 >: OA,OQ1 >: OQ, PA1 >: PA](
    wbs : WellBracketedWOST[PQ1,OA1,OQ1,PA1]
  ) : WellBracketedWPST[PQ1,OA1,OQ1,PA1] = {
  ...
  def negate[PQ1 >: PQ,OA1 >: OA,OQ1 >: OQ, PA1 >: PA](
    wbs : WellBracketedWPST[PQ1,OA1,OQ1,PA1]
  ) : WellBracketedWOST[PQ1,OA1,OQ1,PA1] = {
